...
public class DijkstraUndirectedSP {
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            EdgeWeightedGraph G = new EdgeWeightedGraph(Integer.parseInt(strV));//顶点数,随机边数
            line=br.readLine();
            ...
            DijkstraUndirectedSP sp = new DijkstraUndirectedSP(G, 0);//s 起点
